...
new_audio_dir: Path = Path(
    r"/teamspace/studios/this_studio/north_2023_jun28/Raw_data"
)  # <-------

# Copy in the directory where results should be written
output_folder: Path = Path(
    r"/teamspace/studios/this_studio/north_2023_jun28/inference_results_new"
)  # <-------

# Path to the saved model (must contain: variables, keras_metadata.pb, saved_model.pb)
model_dir: Path = Path(
    r"/teamspace/studios/this_studio/models_160825/retrained_best_model_combined.keras"
)  # <-------
